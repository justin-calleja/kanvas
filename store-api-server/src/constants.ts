...
export const WERT_PRIV_KEY: string = process.env['WERT_PRIV_KEY'] || '';
export const WERT_PUB_KEY: string = process.env['WERT_PUB_KEY'] || '';

export const TEZPAY_PAYPOINT_ADDRESS: string = assertEnv(
